...
class RunDialog(wx.Dialog):
    def __init__(self, fileName, runPreviousArguments, runPreviousExit, *args, **kwds):
        ...
        self.exit = wx.CheckBox(self, -1, "Exit terminal after execution of script")
        self.label = wx.StaticText(self, -1, "Use Edit>Execute to run code snippets in shell")
    ...
    def __set_properties(self):
        ...
        self.SetTitle("Stani's Python Editor - Run")
