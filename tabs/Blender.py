...
class wxgPanel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.modules = wx.ListBox(self, -1, choices=["Blender", "Armatures", "Cameras", "Curves", "Effects", "Images", "Ipos", "IpoCurves", "Lamps", "Lattices", "Materials", "Metaballs", "Objects", "Registry", "Scenes", "Sounds", "Texts", "Textures", "Worlds"], style=wx.LB_SINGLE)
    ...
    def update(self,event=None):
        if self.Blender:
            ...
            if label=='Blender':
                ...
                object=getattr(self.Blender,label[:-1]).Get()
                label='Blender.%s.Get()'%label[:-1]
